      ...
      <div className= "login-main_container">
        ...
        <div className = "login-right">
          ...
          <div className = "company_logo">
            <img src={Union} alt='illustration_image'/>
            <img src={Lendsqr} alt='illustration_image'/>
          </div>
          {/*illustration container*/}
          <div className="illustration_image">
           <img src={Pablo} alt='illustration_image'/>
          </div>  
        </div>
        ...
        <div className = "login-left">
         <div className="login_form">
          <form>
            ...
            {/*input for password*/}
            <input type="password"name="password" placeholder='Your full name' required/>
            <span>SHOW</span>
            {/*login-button*/}
            <p>FORGOT PASSWORD</p>
